  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-xs text-muted-foreground">
            La connexion des ChannelAccount arrive en phase 1 (Instagram), 2 (Telegram) et
            4 (Fanvue). Les credentials ne sont jamais affichés, même à un owner: l&apos;UI
            ne montrera qu&apos;un état de connexion.
          </p>
        </CardContent>
      </Card>
    </div>
