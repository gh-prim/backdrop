...
**Pochettes.** `cover_artwork_thumbnail_uri` est renseigné sur la majorité des pistes sous licence (16 sur 20 dans un échantillon réel), et jamais sur les sons originaux. Il n'est renvoyé que par l'endpoint de **détail**, pas par la recherche: afficher une vignette par ligne coûte donc un appel par piste. D'où le cache mémoire à TTL court côté action — court parce que ces URL sont signées et expirent, et qu'une pochette gardée trop longtemps donne une image cassée plutôt qu'une économie.
